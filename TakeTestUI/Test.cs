...
namespace TestUI
{
    public class Test
    {
        ...
        {
            QuizEndSummaryEventArgs e = new QuizEndSummaryEventArgs(m_summary, GetAnalysis());
            QuizEnded(this, e);
        }
        ...
        public void DataBase_AnswerProvided(object sender, AnswerEventArgs e)
        {
            ...
            // Quiz subscriber uses data from publisher DataBase
